...
public class UpgradeManager
{
    ...
    public static void upgradeToMultiAccount(Activity mActivity, SharedPreferences sp) {
        ...
        Boolean useSSL = sp.getBoolean("emoncms_usessl", false);
        String Grandeur_physique_param = sp.getString("myelectric_Grandeur_physique_param","0");
        String Grandeur_name_autre = sp.getString("myelectric_Grandeur_physique_name","0");
        String Grandeur_unite_autre = sp.getString("myelectric_Grandeur_physique_unite","0");
        ...
        sp.edit().remove("emoncms_url")
                ...
                .remove("myelectric_Grandeur_physique_param")
                .remove("myelectric_Grandeur_physique_name")
                .remove("myelectric_Grandeur_physique_unite")
        ...
        MyElectricSettings settings = new MyElectricSettings(0, "My Electric",Grandeur_physique_param,"","",Integer.parseInt(powerFeed), Integer.parseInt(useFeed), scaleValue, unitCost, costSymbol, "");
