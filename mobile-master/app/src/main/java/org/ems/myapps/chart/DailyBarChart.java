...
public class DailyBarChart {
    ...
    public void refreshChart(int start) {
        ...
        if (chartBarColours != null) {
            ...
            dataSet.setColors(Color.parseColor(attributes.getString(R.styleable.ds_chartBlan)));
        }
    ...
    private void setFormatting() {
        ...
        xAxis2.setTextColor(Color.parseColor(attributes.getString(R.styleable.ds_lightGrey)));
    ...
    private BarData createDataSet() {
        ...
        chart2_dataset.setValueTextColor(Color.parseColor(attributes.getString(R.styleable.ds_lightGrey)));
