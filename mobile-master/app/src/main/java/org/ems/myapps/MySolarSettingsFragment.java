...
public class MySolarSettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        sp1 = PreferenceManager.getDefaultSharedPreferences(getActivity().getBaseContext());
        loadValues();
        powerFeedPreference = (MultiSelectListPreference) this.findPreference("myelectric_power_feed");
    ...
    void loadValues() {
        emoncmsProtocol = sp1.getBoolean("emoncms_usessl", false) ? "https://" : "http://";
        emoncmsURL = sp1.getString("emoncms_url", "");
        emoncmsAPIKEY = sp1.getString("emoncms_apikey", "");
    }
